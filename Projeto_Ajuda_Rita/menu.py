...
def buscar():
    ...
    caminho_antigo = f"A:\\Prof. Cassio de Albuquerque\\Python III\\Alexsandro M\\"

    novo_caminho = f"A:\\Prof. Cassio de Albuquerque\\Python III\\Alexsandro M\\{novo_diretorio}"
